...
def get_args():
    ...
    parser.add_argument('--batch_multiplier', type=int, default=0, help='Increasing Mini-batch Size without Increasing Memory')
...
def train(opt):
    params = Params(f'{opt.project_folder}/{opt.project}.yml')
    ...
    training_set = CocoDataset(root_dir=os.path.join(opt.data_path, params.project_name), set_name=params.train_set,
                                transform=transforms.Compose([Augmenter(),
                                                              Normalizer(mean=params.mean, std=params.std),
                                                              Resizer(input_sizes[opt.compound_coef])]))
    training_generator = DataLoader(training_set, **training_params)

    val_set = CocoDataset(root_dir=os.path.join(opt.data_path, params.project_name), set_name=params.val_set,
        ...
        for epoch in range(opt.num_epochs):
            ...
            for iter, data in enumerate(progress_bar):
                ...
                try:
                    ...
                    if opt.batch_multiplier>0:
                        loss = loss / opt.batch_multiplier
                        count-=1
